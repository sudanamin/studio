...
import com.example.sudan.util.NoData;
...
public class MainActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (!cd.isConnectingToInternet()) {
			Toast.makeText(this.getBaseContext(), "YOU DON'T HAVE INTERNET CONNCETION",
		...
		protected void onPostExecute(JSONObject result) {
			...
			try {
				...
				if (result == null ){
					...
					//Toast.makeText(MainActivity.this.getBaseContext(), "No Data",
					//		Toast.LENGTH_LONG).show();
					Intent i = new Intent(activity, NoData.class);
